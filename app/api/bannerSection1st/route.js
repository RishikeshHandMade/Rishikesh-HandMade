...
export async function POST(req) {
    ...
    try {
        ...
        const newBanner = new BannerSection1st({ buttonLink, order: nextOrder, image });
...
export async function PATCH(req) {
    ...
    try {
        ...
        const updatedBanner = await BannerSection1st.findByIdAndUpdate(id, { buttonLink, order, image }, { new: true });
