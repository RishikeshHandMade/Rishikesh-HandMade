            ...
            >
              ...
              >
                ...
                <div className="w-full flex flex-col items-start p-4 md:p-6">
                  <div className="font-bold text-xl md:text-2xl mb-2 text-gray-900">
                    Name: {cert.title}
                  </div>
                  {cert.issueDate && (
...
const ArtisanDetails = ({ artisan }) => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-amber-50 to-white flex flex-col items-center px-2 md:px-0">
            ...
            <div className="flex flex-col gap-2 md:border-r-2 md:border-black px-2">
              ...
              <div className="font-bold text-md flex items-center">
                ...
                <span className="font-normal text-md">
                  {artisan.shgName || "No SHG Name Avaiable"}
                </span>
              </div>
              <div className="font-bold text-md flex items-center">
                {" "}
                Artisan No:{" "}
                <span className="font-normal text-md">
                  {artisan.artisanNumber || "Artisan Number Not Available"}
                </span>
              </div>
              <div className="text-md font-semibold text-black">
                {artisan.yearsOfExperience || "0"} Years of Experience
              </div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-2 mt-2 mb-2">
                      ...
                      {artisan.contact.callNumber && (
                        <a
                          href={`tel:${artisan.contact?.callNumber}`}
                  ...
                  >
                    <div className="flex flex-col w-full md:w-[290px]">
                      ...
                      <div className="relative w-full h-96 rounded-3xl overflow-hidden flex items-center justify-center group/image">
                                ...
                                const wishlistItem = {
                                  ...
                                  discountPercent:
                                    coupon && typeof coupon.percent === "number"
                                      ...
                                      : undefined,
                                  discountAmount:
                                    coupon && typeof coupon.amount === "number"
                                      ? coupon.amount
                                      : undefined,
                                  cgst:
                                    (item.taxes && item.taxes.cgst) ||
                        ...
                        <Image
                          src={
                            item?.gallery?.mainImage?.url || "/placeholder.jpeg"
                          }
                      ...
                      <div className="flex flex-col items-start justify-between px-1 pt-4 pb-2 mt-0">
                        <Link
                          ...
                          className="font-bold hover:underline text-lg text-gray-900 leading-tight text-wrap truncate cursor-pointer"
                        >
                          {item?.title}
                        </Link>
                        <div className="flex items-center justify-between w-full gap-2">
                          {(() => {
                            ...
                            if (hasDiscount && discountedPrice < price) {
                              return (
                                <span>
                                  <del className="text-black font-bold text-md ">
                                    ₹{formatNumeric(price)}
                                  </del>
                                  <span className="font-bold text-md md:text-x text-black px-2">
                                    ₹
      ...
      {Array.isArray(artisan.certificates) &&
            ...
            <div className="w-full h-full md:h-[500px] mx-auto flex flex-col md:flex-row items-start justify-center px-5 py-1 gap-8">
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center gap-5 md:gap-10 h-full">
                ...
                <p className="text-gray-700 text-md text-justify leading-relaxed">
                  We extend our heartfelt congratulations to you on the
                  remarkable achievement of reaching your goal. Your dedication,
                  skill, and unwavering commitment to excellence have truly set
                  you apart. As an artisan, your work reflects not only your
                  talent but also the passion and perseverance that define true
                  craftsmanship. It is with great pride and admiration that we
                  recognize your outstanding accomplishment. May this milestone
                  be a stepping stone to even greater success in your journey.
                  We are honored to celebrate this moment with you and look
                  forward to your continued excellence.
                </p>
                <Link
                  href="/contact"
                  className="bg-black text-white py-3 px-6 my-2 rounded-lg font-semibold text-lg w-fit mb-6"
                >
                  Connect With Us
                </Link>
              </div>
        ...
        <div className="flex flex-col md:flex-row items-start gap-5 ">
          ...
          <div className="flex-1 flex flex-col justify-center my-4 md:pr-8">
            <h2 className="text-2xl md:text-3xl font-bold text-start mb-2 uppercase">
              <span className="border-t-4 border-black">Meet Our Artisans</span>
            </h2>
            ...
            <div className="text-md text-gray-700 mb-6">
              We are proud to recognize and celebrate your exceptional talent
              and dedication as a skilled handicraft artisan. Your ability to
              transform raw materials into beautiful, meaningful works of art
              speaks to your creativity, precision, and passion for the craft.
              Each piece you create is a testament to the enduring value of
              handmade artistry and the cultural richness it preserves. With
              deep appreciation, we commend you for achieving this milestone and
              look forward to witnessing your continued journey of artistic
              excellence.
            </div>
          </div>
