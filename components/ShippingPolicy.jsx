      ...
      <div className="border border-black p-4 rounded-xl shadow-sm">
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <p className="text-justify mt-1">
              Please enter your pincode on the product page (you don't have to enter it every single time) to know whether the product can be delivered to your location.  If you haven't provided your pin code until the checkout stage, the pin code in your shipping address will be used to check for serviceability.<br />
          ...
          <div className="space-y-5">
            ...
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>8. I need to return an item, how do I arrange for a pick-up? :- </b>
                ...
                Wherever possible  www.rishikeshhandmade.com  (E Commerce Website Of Rishikesh Natural Fiber Handicrafts Producer Company Pvt. Ltd.
) delivery partner's Logistics will facilitate the pick-up of the item. In case, the pick-up cannot be arranged through  www.rishikeshhandmade.com  (E Commerce Website Of Rishikesh Natural Fiber Handicrafts Producer Company Pvt. Ltd.
)-delivery partner's, you can return the item through a third-party courier service. Return fees are borne by the Seller.
              </p>
            </div>
            <div>
            ...
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>10. What do the different tags like "In Stock", "Available" mean? :- </b><br />
                ...
                For items listed as "In Stock", Sellers will mention the delivery time based on your location pin code (usually 2-3 business days, 4-5 business days or 4-6 business days in areas where standard courier service is available). For other areas, orders will be sent by Registered Post through the Indian Postal Service which may take 1-2 weeks depending on the location.<br />
            ...
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>11.  www.rishikeshhandmade.com  (E Commerce Website Of Rishikesh Natural Fiber Handicrafts Producer Company Pvt. Ltd.
) :- </b>
