...
const OrderConfirm = ({ orderId = '267676GHERTI05467', onViewOrder, onBackHome }) => {
  return (
    <div className="bg-[#fdf7f1] rounded-2xl max-w-[700px] mx-auto my-10 p-9 border border-[#f5e9d9] shadow-md text-center">
      ...
      <div className="flex justify-center gap-5">
        ...
        <button
          onClick={onBackHome}
          className="bg-white text-black border-2 border-black rounded-lg px-7 py-3 font-semibold text-base hover:bg-gray-100 transition-colors"
        >
          Back To Home
        </button>
      </div>
