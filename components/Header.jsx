  ...
  return (
    <header
      className={`print:hidden ${pathName.includes("admin") ||
        ...
        ? "hidden"
        : "block"
        } bg-[#fcf7f1] text-black drop-shadow-lg fixed top-0 left-0 right-0 transition-all duration-300 font-barlow tracking-wider ease-in-out z-50 mx-auto w-full py-2
