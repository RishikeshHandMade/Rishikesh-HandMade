...
const FeaturedOffer = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto py-10 w-full">
            <h2 className="text-2xl font-bold mb-6">{editBanner ? "Edit Featured Offer" : "Add New Featured Offer"}</h2>
            <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded-lg p-6 space-y-4">
                {/* Banner Image Upload */}
                <div className="mb-4">
                    <Label className="block mb-2 font-bold">Featured Offer Image</Label>
                    <input
                        type="file"
                        accept="image/*"
