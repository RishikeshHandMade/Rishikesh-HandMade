                ...
                <div className="w-full py-10 px-2 md:py-20 bg-[#ededed]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4 ">
                        {promotinalBanner.map((item, idx) => (
                            <div key={idx} className="flex flex-col h-[200px] md:h-[400px] overflow-hidden relative group">
                                <Link
                                ...
                                >
                                <img src={item.image?.url} alt={item.title} className="absolute inset-0 w-full h-full md:object-contain object-contain object-center transition-transform duration-300 group-hover:scale-105" />
                                </Link>
                            </div>
                        ))}
                    </div>
                        ...
                        <CarouselContent>
                            {featuredOffer.map((item, idx) => (
                                <CarouselItem key={idx} className="md:basis-1/3 lg:basis-1/4">
                                    <div className="flex flex-col h-[400px] md:h-[350px] p-0 overflow-hidden relative group">
